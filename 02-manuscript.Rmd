...
figs1_1a
# ggsave(filename = "mssm_figures/FigS1_1a.pdf", figs1_1a, width = 12, height = 5)
# ggsave(filename = "mssm_figures/FigS1_1a.png", figs1_1a, width = 12, height = 5)
```
...
figs1_1b <- ggplot() +
  ...
  theme(legend.position = "bottom")
figs1_1b
# ggsave(filename = "mssm_figures/FigS1_1b.pdf", figs1_1b, width = 12, height = 9)
# ggsave(filename = "mssm_figures/FigS1_1b.png", figs1_1b, width = 12, height = 9)
```



```{r FigS1_1c, warning = FALSE, comments = "", message = FALSE}
...
ggsave("mssm_figures/FigS1.png", figs1, width = 10, height = 13, dpi = 300)
```
...
figs3_2_2
ggsave(filename = "mssm_figures/FigS3_2_2.pdf", figs3_2_2, width = 8, height = 7)
ggsave(filename = "mssm_figures/FigS3_2_2.png", figs3_2_2, width = 8, height = 7)
```
...
figs3_3_1
ggsave(filename = "mssm_figures/FigS3_3_1.pdf", figs3_3_1, width = 8, height = 7)
ggsave(filename = "mssm_figures/FigS3_3_1.png", figs3_3_1, width = 8, height = 7)
```
...
figs3_3_2
ggsave(filename = "mssm_figures/FigS3_3_2.pdf", figs3_3_2, width = 8, height = 7)
ggsave(filename = "mssm_figures/FigS3_3_2.png", figs3_3_2, width = 8, height = 7)
```
...
figs3_3_3a
ggsave(filename = "mssm_figures/FigS3_3_3a.pdf", figs3_3_3a, width = 8, height = 7)
ggsave(filename = "mssm_figures/FigS3_3_3a.png", figs3_3_3a, width = 8, height = 7)
```
...
figs3_4_1
ggsave(filename = "mssm_figures/FigS3_4_1.pdf", figs3_4_1, width = 8, height = 11)
ggsave(filename = "mssm_figures/FigS3_4_1.png", figs3_4_1, width = 8, height = 11)
```
...
figs3_4_4
ggsave(filename = "mssm_figures/FigS3_4_4.pdf", figs3_4_4, width = 8, height = 6)
ggsave(filename = "mssm_figures/FigS3_4_4.png", figs3_4_4, width = 8, height = 6)
```
...
figs3_4_5 <- sn3_4_physeq_lg %>%
  ...
  theme(legend.position = "bottom")
figs3_4_5
# ggsave(filename = "mssm_figures/FigS3_4_5.pdf", figs3_4_5, width = 8, height = 7)
# ggsave(filename = "mssm_figures/FigS3_4_5.png", figs3_4_5, width = 8, height = 7)
```
...
figs3_5_1a
# ggsave(filename = "mssm_figures/FigS3_5_1a.pdf", figs3_5_1a, width = 8, height = 6)
# ggsave(filename = "mssm_figures/FigS3_5_1a.png", figs3_5_1a, width = 8, height = 6)
```
...
figs3_5_1
ggsave("mssm_figures/FigS3_5_1.png", figs3_5_1, width = 10, height = 13, dpi = 300)
ggsave("mssm_figures/FigS3_5_1.pdf", figs3_5_1, width = 10, height = 13)
```
...
save_heatmap <- function() {
  ...
  pdf("mssm_figures/Fig5a.pdf", width = 10, height = 8.8) # Adjust to desired paper size
...
save_heatmap <- function() {
  png("mssm_figures/Fig5a.png", width = 2500, height = 2200, res = 300)
  fig5a %>% ComplexHeatmap::draw(
    annotation_legend_list = attr(fig5a, "AnnoLegends"),
    heatmap_legend_side = "bottom",
    annotation_legend_side = "bottom"
...
figs4_2
ggsave("mssm_figures/FigS4_2.png", figs4_2, width = 10, height = 9, dpi = 300)
```
...
ggsave(filename = "mssm_figures/macroquant_lawsonibacter_bar.png", macroquant_lawsonibacter_bar, width = 10, height = 7)
...
fig6_a
ggsave(filename = "mssm_figures/Fig6_a.pdf", fig6_a, width = 10, height = 5)
ggsave(filename = "mssm_figures/Fig6_a.png", fig6_a, width = 10, height = 5)

ggsave(
  filename = "mssm_figures/Fig6_a_legend.png",
...
lawsonibacter_popANI_meta <- macroquant_metrics_filt_30 %>%
  filter(
    ...
    !microsample %in% c(
      ...
      "M300833", "M300886"
    ) # exclude based on spatial coordinate SAME
  ) %>%
...
# facet_wrap(~bin)
fig6_c
# ggsave(filename = "mssm_figures/Fig6_c.pdf", fig6_c, width = 10, height = 5)
# ggsave(filename = "mssm_figures/Fig6_c.png", fig6_c, width = 10, height = 5)
```
...
# ggsave(filename = "mssm_figures/Fig6_b.pdf", fig6_b, width = 10, height = 5)
# ggsave(filename = "mssm_figures/Fig6_b.png", fig6_b, width = 10, height = 5)
```
...
##### Strategy 1 
```{r distance_decay_1, warning = FALSE, comments = "", message = FALSE}
set.seed(1234)
...
toplot <- data.frame(
  spat_dist = as.numeric(spatial_distance_lmp),
