...
```{r plot_collection_attempts, echo = FALSE, warning=FALSE, comments="", message=FALSE, fig.height=5, fig.width=8}
...
```{r plot_collection_attempts_LMD_area, echo = FALSE, warning=FALSE, comments="", message=FALSE, fig.height=5, fig.width=8}
...
```{r plot_collection_attempts_1, echo = FALSE, warning=FALSE, comments="", message=FALSE, fig.height=5, fig.width=7}
...
```{r mock_RMSE_calculation, echo = FALSE, warning=FALSE, comments="", message=FALSE}
...
```{r FigS3_2_1, echo = FALSE, warning=FALSE, comments="", message=FALSE, fig.height=9, fig.width=7}
...
### Fig. 3b
```{r Fig3b,  echo=FALSE, warning = FALSE, comments = "", message = FALSE, fig.height = 5, fig.width = 8}
...
### Fig. 3c
```{r Fig3c, warning = FALSE, echo=FALSE, comments = "", message = FALSE, fig.height = 6, fig.width = 8}
...
### Fig. 3d
```{r Fig3d, echo=FALSE, warning = FALSE, comments = "", message = FALSE, fig.height = 6, fig.width =8}
