...
```{r load_data_development, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r fig_2a, echo = TRUE, warning = FALSE, comments = "", message = FALSE, fig.height=5, fig.width=7}
...
```{r fig_2b, echo = TRUE, warning = FALSE, comments = "", message = FALSE, fig.height=12, fig.width=7}
...
```{r suppl_note_1, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r suppl_note_1_samples, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
#### Read Counts 
```{r SN1_read_count, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r sn1_alpha_df, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r FigS1_1a, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
##### Richness {-}
```{r paired_Wilcoxon_Richness, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
# 5 nas?
wt <- wilcox.test(
...
##### Neutral {-}
```{r paired_Wilcoxon_Neutral, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
# 5 nas?
knitr::kable(
  wilcox.test(
...
#### Detected Taxa
```{r sn1_alpha_taxa, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r sn1_alpha_unique_species, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r sn1_alpha_unique_genera, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r sn1_beta_dfs, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r FigS1_1b, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r FigS1_1c_aldex, echo = TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r plot_collection_attempts, echo = TRUE, warning=FALSE, comments="", message=FALSE, fig.height=5, fig.width=8}
...
```{r plot_collection_attempts_LMD_area, echo = TRUE, warning=FALSE, comments="", message=FALSE, fig.height=5, fig.width=8}
...
```{r plot_collection_attempts_1, echo = TRUE, warning=FALSE, comments="", message=FALSE, fig.height=5, fig.width=7}
...
```{r FigS3_2_1, echo = TRUE, warning=FALSE, comments="", message=FALSE, fig.height=9, fig.width=7}
...
```{r sn3_2_df, echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r FigS3_2_2,  echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.width=8, fig.height=8}
ordered_metrics <- c(
...
###### Caecum {-}
```{r sn3_2_a_caecum,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
###### Colon {-}
```{r sn3_2_a_colon,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Counts (integers ≥0): poisson, quasipoisson (accounts overdispersion)
...
###### Caecum {-}
```{r sn3_2_b_caecum,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
###### Colon {-}
```{r sn3_2_b_colon,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Proportions (0–1 continuous):	quasibinomial GLM (accounts overdispersion)
...
###### Caecum {-}
```{r sn3_2_c_caecum,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Proportions (0–1 continuous):	quasibinomial GLM (accounts overdispersion)
...
```
###### Colon {-}
```{r sn3_2_c_colon,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Proportions (0–1 continuous):	quasibinomial GLM (accounts overdispersion)
...
###### d. Richness {-}
###### Caecum {-}
```{r sn3_2_d_caecum,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Counts (integers ≥0): poisson, quasipoisson (accounts overdispersion)
...
###### Colon {-}
```{r sn3_2_d_colon,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Counts (integers ≥0): poisson, quasipoisson (accounts overdispersion)
...
###### e. Neutral {-}
###### Caecum {-}
```{r sn3_2_e_caecum,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```
###### Colon {-}
```{r sn3_2_e_colon,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r sn3_2_taxa,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
###### f. Phylogenetic {-}
###### Caecum {-}
```{r sn3_2_f_caecum,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
###### Colon {-}
```{r sn3_2_f_colon,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r sn3_3_df,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r FigS3_3_1,  echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.width=8, fig.height=8}
ordered_metrics <- c(
  "total_after_filtering.total_reads",
...
##### a. Reads Retained Post Quality Filtering {-}
```{r sn3_3_a,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Counts (integers ≥0): poisson, quasipoisson (accounts overdispersion)
...
##### b. Low Quality Reads (%) {-}
```{r sn3_3_b,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Proportions (0–1 continuous):	quasibinomial GLM (accounts overdispersion)
...
```{r sn3_3_c,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Proportions (0–1 continuous):	quasibinomial GLM (accounts overdispersion)
...
```{r d_sectioncomp,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Proportions (0–1 continuous):	quasibinomial GLM (accounts overdispersion)
...
```{r Boxplot_19versus15Cycles,  echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.width=8, fig.height=8}
ordered_metrics <- c(
...
```{r reads_cyclecomp,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Counts (integers ≥0): poisson, quasipoisson (accounts overdispersion)
...
```{r readsfilt_cyclecomp,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Counts (integers ≥0): poisson, quasipoisson (accounts overdispersion)
...
##### c. Low Quality Reads (%) {-}
```{r quality_cyclecomp, echo=TRUE,  warning = FALSE, comments = "", message = FALSE}
# Proportions (0–1 continuous):	quasibinomial GLM (accounts overdispersion)
...
```{r duplication_cyclecomp,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
# Proportions (0–1 continuous):	quasibinomial GLM (accounts overdispersion)
...
```{r physeq_section_lg,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r figs3_3_2,  echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.width=8, fig.height=9}
...
##### Differential Abundance (Aldex2) {-}
```{r physeq_section,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r sn3_3_dapi_df,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r figs3_3_3a,  echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.width=8, fig.height=9}
...
```{r FigS3_4_1,  echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.width=8, fig.height=11}
ordered_metrics <- c(
  "total_before_filtering.total_reads",
  "lowquality_reads_pct",
...
#### FigS3_4_2
```{r FigS3_4_2,  echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.height = 6, fig.width=7.5}
...
```{r FigS3_4_3,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r neg_retained_filt, echo=TRUE, warning=FALSE, comments="", message=FALSE}
macroquant_metrics_filt_30 %>%
  filter( batch == "MSEB0006" | batch == "MSEB0009" | batch == "MSEB0011" | batch == "MSEB0014" | batch == "MSEB0015" | batch == "MSEB0010" | batch == "MSEB0012") %>% 
...
#### Composition
```{r figs3_4_5,  echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.width=8, fig.height=8}
...
```{r Fig3_prep, echo=TRUE,  warning = FALSE, comments = "", message = FALSE}
...
### Fig. 3b
```{r Fig3b,  echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.height = 5, fig.width = 8}
...
```{r Fig3_mapped_mag_median, echo=TRUE,  warning = FALSE, comments = "", message = FALSE}
# Mapped MAG median
...
### Fig. 3c
```{r Fig3c, warning = FALSE, echo=TRUE, comments = "", message = FALSE, fig.height = 6, fig.width = 8}
...
### Fig. 3d
```{r Fig3d, echo=TRUE, warning = FALSE, comments = "", message = FALSE, fig.height = 6, fig.width =8}
...
```{r sn3_5_df,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r sn3_5_median_pct,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
sn3_5_df_t <- sn3_5_df %>%
  mutate(
...
```{r FigS3_5_1a,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
ordered_metrics <- c(
  # "total_before_filtering.total_reads",
  "low_quality_reads",
  "reads_mapped_chicken",
...
```{r sn3_5_dreamprep_df ,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
...
```{r FigS3_5_1b,  echo=TRUE, warning = FALSE, comments = "", message = FALSE}
