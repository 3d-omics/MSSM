...
```{r load_data_implementation, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r data_spatial_clr, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r diversity_partitioning, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r cryosection_ca, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
metadata %>% 
...
##### Mantel Test {-}
```{r caecum_spatial_mantel, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
##### Mantel Correlogram {-}
```{r caecum_spatial_mantelcor, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
results_ca$mantelcor_results
```

```{r caecum_spatial_mantelcor_plot, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
#####  Distance Decay {-}
```{r caecum_spatial_decay, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r caecum_spatial_decay_plot, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
results_ca$distance_decay_plots$G121eI104C
```

#### Colon Cryosection (G121eO301A)
```{r cryosection_c0, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
metadata %>% 
...
##### Mantel Test {-}
```{r colon_spatial_mantel, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r colon_spatial_mantelcor, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
results_co$mantelcor_results
```

```{r colon_spatial_mantelcor_plot, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r colon_spatial_decay, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r colon_spatial_decay_plot, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r prepare_data_rlqESLTP, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r correspondence_rlqESLTP, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
coacomp <- dudi.coa(comp, scan = FALSE, nf = 108)
```

###### Gabriel graph {-}

```{r gabriel_graph, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r gabriel_graph_plot, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r env_pca, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
pcaenv <- dudi.pca(env, row.w = coacomp$lw, scannf = FALSE, nf = 2)
```

###### Trait-based distances {-}

```{r distances_traits, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r distances_phylogeny, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r extended_rlq, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
rlqmix <- rlqESLTP(pcaenv, pcaspa, coacomp, pcotraits, pcophy, scan = F, nf = 2)
```

```{r extended_rlq_barplot, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
barplot(rlqmix$eig)
```

```{r extended_rlq_table, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
rlqmix$eig %>%
  tibble(eigenvalue = .) %>%
  mutate(
...
```{r extended_rlq_axis1_1, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r extended_rlq_axis1_positive_genomes, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
rlqmix$lQ %>% 
...
```{r extended_rlq_axis1_negative_genomes, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
rlqmix$lQ %>% 
  rownames_to_column(var="genome") %>%
  left_join(macromag_taxonomy %>%  mutate(genome=sub(":", "_", genome)),by="genome") %>% 
  arrange(AxcQ1) %>% 
...
```{r pangenome_lawsonibacte_Fig6_a, echo = TRUE,  warning = FALSE, comments = "", message = FALSE, fig.width=8, fig.height=9}
...
```{r Fig6_b, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r lawsonibacter_mantel_G121e_cryo_pa, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r lawsonibacter_mantel_G121e_cryo, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r lawsonibacter_mantel_G103b_pa, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
##### Abundance {-}
```{r lawsonibacter_mantel_G103b, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
```{r Fig6_d, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
...
**Note:** The ani_spatial_analysis() function needs to be loaded.

```{r mantel_cor_bins, echo = TRUE,  warning = FALSE, comments = "", message = FALSE}
