...
- Jorge Langa^[University of xxxx, jorge.langa@sund.ku.dk]
...
pacman::p_load(
  tidyverse, rairtable, jsonlite, ape, # If the package is not installed, installs from CRAN
...
pacman::p_load_gh(
  "anttonalberdi/hilldiv2", # If the package is not installed, installs from GitHub
...
```{r parse_fastp_function, warning = FALSE, comments = "", message = FALSE}
...
```{r fit_and_analyze_model(), warning = FALSE, comments = "", message = FALSE}
...
### pivot_phylo
```{r pivot_phylo, warning = FALSE, comments = "", message = FALSE}
...
```{r lawsonibacter_mantel_analysis, warning = FALSE, comments = "", message = FALSE}
...
```{r run_ani_spatial_analysis, warning = FALSE, comments = "", message = FALSE}
...
**Note:** This step requires access to the raw data files located at xxxx. If you prefer to skip this step, you can proceed to the next section, making sure to load the R object that contains the necessary files for the subsequent analysis in xxx.
...
<!--chapter:end:02-method_development.Rmd-->
...
<!--chapter:end:03-method_validation.Rmd-->
...
```{r lawsonibacter_mantel_G121e_cryo1, warning = FALSE, comments = "", message = FALSE}
...
```{r lawsonibacter_mantel_G121e_cryo2, warning = FALSE, comments = "", message = FALSE}
lawsonibacter_G121e <- lawsonibacter_mantel_analysis(
...
```{r test_distance_1, warning = FALSE, comments = "", message = FALSE}
# Subset coordinate
...
```{r test_distance_2, warning = FALSE, comments = "", message = FALSE}
# Subset coordinate
coords <- lawsonibacter_popANI_meta %>%
  filter(cryosection %in% c("G121eI104C")) %>%
  select(microsample, Xcoord, Ycoord)
...
<!--chapter:end:04-method_implementation.Rmd-->
